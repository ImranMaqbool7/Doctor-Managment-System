...
import { Badge, BadgeIndianRupee, EyeClosed, Star, Trash2, User, Users } from 'lucide-react';
...
const removeDoctor = async (id) => {
  ...
  try {
    const token = await getToken(); // ✅ ADD THIS LINE
                     ...
                     Patients
                      ...
                      <div className={doctorListStyles.actionContainer}>
                        <div className='flex items-center gap-2'>
                          <button onClick={() => removeDoctor(doc._id)} className={doctorListStyles.deleteButton}>
