...
import { serviceDashboardStyles } from '../assets/frontend/dummyStyles';
            ...
            <div className={serviceDashboardStyles.header.container}>
                ...
                <div className={serviceDashboardStyles.refresh.container}>
                    ...
                    <button onClick={() => {
                      ...
                      fetchServices({showLoading: true});
                    }} className={serviceDashboardStyles.refresh.button(Array.isArray(servicesProp))} title={Array.isArray(servicesProp) ?
                      "Services provided by parent component" : "Refresh"
                     }>
                        Refresh
                    </button>
