...
import { editProfilePageStyles, iconSize } from "../assets/frontend/dummyStyles";
...
export default function EditProfilePage({ apiBase }) {
  ...
  const API_BASE = "https://doctor-managment-system-production.up.railway.app/api/doctors";
