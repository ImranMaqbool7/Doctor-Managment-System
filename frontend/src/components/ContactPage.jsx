...
import { Mail, MapPin, MessageSquare, Phone, PhoneIcon, SendHorizonal, Stethoscope, User } from 'lucide-react';
    ...
    <div className={contactPageStyles.pageContainer}>
     <div className={contactPageStyles.bgAccent1}></div>
       ...
       <div className={contactPageStyles.gridContainer}>
         ...
         Fill the form - we'll open Whatapp so you contact with us 
         instantly.
           </p>
           <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            ...
            <div className={contactPageStyles.buttonContainer}>
              ...
              <SendHorizonal size={18} /> <span>Send Via Whatapp</span>
               </button>
               {sent && (
         ...
         <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            <h3 className={contactPageStyles.infoTitle}>
             ...
             Nighebanpura, Faisalabad, Punjab 
             </p>
             <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> +923271577033
             </p>
             <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> naweeragujjar@gmail.com
             </p>
          </div>
         <iframe
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d108993.31453222065!2d73.06280940317578!3d31.385430815446487!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39226940221cbeb9%3A0x87aed33b83a332bd!2sEdify%20College%20of%20IT!5e0!3m2!1sen!2s!4v1780892655020!5m2!1sen!2s"
  width="600"
  height="450"
  style={{ border: 0 }}
  allowFullScreen
