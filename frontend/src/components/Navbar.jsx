...
import { navbarStyles } from '../assets/frontend/dummyStyles'
...
import logo from '../assets/frontend/public/logo.png'
import { Key, User, X, Menu } from 'lucide-react';
          ...
          {item.label}
           ...
           {isOpen && (
            ...
            {navItems.map((item, idx) =>{
             const isActive = location.pathname === item.href;
             return(
              <Link key={idx} to={item.href} onClick={() => setIsOpen(false)} className={`${navbarStyles.mobileMenuItem} ${
